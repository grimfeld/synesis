...
1. Installez **Syncthing for macOS** (app de barre de menus) depuis [github.com/syncthing/syncthing-macos/releases](https://github.com/syncthing/syncthing-macos/releases), ou avec Homebrew : `brew install --cask syncthing`. Lancez-le ; une icône Syncthing apparaît dans la barre de menus. Il démarre à l'ouverture de session par défaut. Si macOS le demande, autorisez les connexions entrantes.
