...
1. Installez **Syncthing for macOS** (app de barre de menus) depuis [github.com/syncthing/syncthing-macos/releases](https://github.com/syncthing/syncthing-macos/releases), ou avec Homebrew : `brew install --cask syncthing`.
2. Lancez-le ; une icône Syncthing apparaît dans la barre de menus. Il démarre à l'ouverture de session par défaut.
3. Si macOS le demande, autorisez les connexions entrantes.
...
Chemin de coffre suggéré sur un Mac : `~/Sync/Synesis`.
