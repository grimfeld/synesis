...
1. Téléchargez **SyncTrayzor** (Syncthing avec icône de barre d'état et démarrage automatique) depuis [github.com/canton7/SyncTrayzor/releases](https://github.com/canton7/SyncTrayzor/releases), ou Syncthing seul depuis [syncthing.net/downloads](https://syncthing.net/downloads/).
2. Lancez-le. Autorisez-le dans le pare-feu Windows pour les réseaux privés quand on vous le demande ; c'est ce qui permet aux appareils de se trouver sur votre Wi-Fi.
3. Dans SyncTrayzor, cochez **Démarrer à l'ouverture de session** et **Démarrer réduit**.
...
Chemin de coffre suggéré sur Windows : `C:\Users\<vous>\Sync\Synesis`.
