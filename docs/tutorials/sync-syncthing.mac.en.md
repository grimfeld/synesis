...
1. Install **Syncthing for macOS** (menu-bar app) from [github.com/syncthing/syncthing-macos/releases](https://github.com/syncthing/syncthing-macos/releases), or with Homebrew: `brew install --cask syncthing`. Launch it; a Syncthing icon appears in the menu bar. It starts at login by default. If macOS asks, allow incoming connections.
