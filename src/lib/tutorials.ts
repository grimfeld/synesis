// Tutorials (PLAN §25, CONTEXT "Tutorial"): bundled markdown, one file per
...
/** The feature Tutorials, in the order the catalogue gives them (PLAN §25.10). */
...
/**
 * Which Tutorials a view lists (PLAN §25.1, §25.10). The table lives here, not
...
// ---- progress (PLAN §25.11): per Device, keyed by id, never by language.
...
// ---- pictures (PLAN §25.12): on trial, chosen in Settings → Appearance.
