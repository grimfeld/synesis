...
// PLAN §24.3) and the rules from ./syncRules, re-exported for the UI.
...
/** Tutorial markdown for a method on a Device kind, in the UI language. No English fallback (PLAN §24.4). */
